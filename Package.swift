...
if ProcessInfo.processInfo.environment["SWIFTPM_LLBUILD_FWK"] == nil {
    if ProcessInfo.processInfo.environment["SWIFTCI_USE_LOCAL_DEPS"] == nil {
        package.dependencies += [
            .package(url: "https://github.com/finestructure/swift-llbuild.git", .branch(relatedDependenciesBranch)),
        ]
    } else {
...
if ProcessInfo.processInfo.environment["SWIFTCI_USE_LOCAL_DEPS"] == nil {
    package.dependencies += [
        .package(url: "https://github.com/finestructure/swift-tools-support-core.git", .branch(relatedDependenciesBranch)),
